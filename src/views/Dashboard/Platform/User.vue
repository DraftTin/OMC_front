...
<template>
	...
	<el-dialog v-model="addUserDialogVisible" title="新增运营方" :before-close="handleClose" width="40%">
		<el-form ref="formRef" :model="form" :rules="rules" label-position="top" id="form">
			...
			<el-row :gutter="60">
				<el-col>
					<el-form-item label="运营方权限" prop="permissions">
